...
public void deleteRecordById(String record){
    WashRecord washRecord = washRecordRepository.findById(record).orElse(null);
    if(washRecord!=null){
        washRecordRepository.deleteById(record);
    }else {
        throw new RuntimeException("el empleado " + record + " Not found");
    }}
