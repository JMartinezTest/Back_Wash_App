...
public class WashRecordController {
    ...
    public ResponseEntity<String> deleteWashRecord(@PathVariable("record") String record){
          washRecordService.deleteRecordById(record);
          return ResponseEntity.ok("Registro "+ record + " eliminado.");
    }
